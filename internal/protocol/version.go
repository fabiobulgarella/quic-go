...
const (
	VersionTLS      VersionNumber = 0xf0f0f1f3 // Telecom Italia DelayBit version
	...
	VersionDelayBit VersionNumber = 0xf0f0f1f3
)

// SupportedVersions lists the versions that the server supports
// must be in sorted descending order
var SupportedVersions = []VersionNumber{VersionDelayBit, VersionDraft29, VersionDraft34, VersionDraft32}
